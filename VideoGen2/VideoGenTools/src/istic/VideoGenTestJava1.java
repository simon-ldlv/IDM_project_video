...
public class VideoGenTestJava1 {
	...
	public void init() {
		...
		this.station = new VideoGenStation();
	...
	public void testGenerateVideo2LongestAndGif() {
		...
		String outVideogenConcat = station.genererLongestVideo(configVideogen);
		
		File f = new File(outVideogenConcat);
		assertTrue(f.exists());
		assertTrue(!f.isDirectory());
		
		String outVideoGif = station.genererGifWithVideo(outVideogenConcat);
	...
	@Test
	public void testGenerateVideo2Custom() {
	
		String configVideogen = "example2.videogen";
		
		String outVideogenConcat = station.genererCustomVideo(configVideogen, null, null);
	...
	public void testGenerateVideo1Random() {
		...
		String outVideogenConcat = station.genererVideoRandom(configVideogen);
	...
	public void testGenererAllVignettes() {
		...
		ArrayList<String> listVignettes = station.genererVignette(configModel);
